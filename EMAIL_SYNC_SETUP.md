...
בדשבורד נוסף כפתור `סנכרן מיילים`. הוא מפעיל את הסנכרון מיידית מתוך האתר, בלי להזין קוד בכל פעם, ומציג כמה פניות חדשות נוספו וכמה מיילים נמחקו מה-Inbox אחרי עיבוד מוצלח.

## 4. הפעלה כל 5 דקות

ב-`render.yaml` מוגדר Render Cron שמריץ כל 5 דקות:
