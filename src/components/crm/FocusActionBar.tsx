...
export function FocusActionBar({
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-[calc(4.75rem+env(safe-area-inset-bottom))] z-fab flex justify-center px-6 md:bottom-[max(1rem,env(safe-area-inset-bottom))]">
